...
export async function addBook(listing){
...
export async function editBook(bookId, book){
    return await api.put(host + `/data/books/${bookId}`, book);
}
...
export async function getTotalBookLikes(bookId){
...
export async function checkIfUserLikedABook(bookId, userId){
